    ...
    <form method="post" id="ticket_form"> 
        ...
        <div class="col-lg-6">
            <fieldset class="form-group">
                <label class="form-label semibold" for="categoria_id">Categoría</label>
                <select id="categoria_id" name="categoria_id" class="form-control">
                    <!-- Aquí deberías agregar las opciones del select -->
                </select>
            </fieldset>
        </div>
        <div class="col-lg-6">
            <fieldset class="form-group">
                <label class="form-label" for="ticket_titulo">Título</label>
                <input type="text" class="form-control" id="ticket_titulo" name="ticket_titulo" placeholder="Ingresa el título">
            </fieldset>
        </div>
        <div class="col-lg-12">
            <fieldset class="form-group">
